...
from education_system.models.database import User, Student, Teacher, Role, Course, OfferedCourse, CourseSelection, Grade
import hashlib
...
def student_dashboard():
    ...
    student_data = {
        ...
        'class_name': student.class_obj.name if student.class_obj else '未设置'
    }
...
def admin_dashboard():
    ...
    stats = {
        ...
        'pending_approvals': 0  # 暂时设为0，可以后续实现
    }
...
@app.route('/admin/application_approval')
